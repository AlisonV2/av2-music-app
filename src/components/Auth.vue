<template>
  ...
  <div class="fixed z-10 inset-0 overflow-y-auto" id="modal"
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center
      ...
      <div class="inline-block align-bottom bg-white opacity-90 rounded-lg text-left overflow-hidden
        shadow-xl transform transition-all md:my-8 md:align-middle max-w-lg w-full">
            ...
            <li class="flex-auto text-center">
              <a class="block rounded py-3 px-4 transition"
                ...
                :class="{
                  ...
                  'hover:text-pink-500': tab === 'register'
                }">
                Login
              </a>
            </li>
